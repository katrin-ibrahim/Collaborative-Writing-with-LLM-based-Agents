...
class ContentToolkit:
    ...
    def create_context_from_results(self, search_results: List[SearchResult], max_length: int = 2000) -> str:
    ...
    def generate_section_content(self, section_title: str, 
                                context: str, 
                                article_topic: str,
                                api_client,
                                target_length: str = "300-400") -> str:
